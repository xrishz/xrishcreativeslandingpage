...
## Positioning
XRISH CREATIVES is an event photography and film team led by Elrish John Rull. This is a portfolio experience, not a services catalogue or software landing page.
...
## Evidence on Hand
16 original JPEG photographs in PHOTOS. No film files, verified video URLs, team portraits, testimonial copy or project metadata supplied. Use descriptive editorial collection titles rather than inventing client identities. Only KHATRINA is identified by filenames; do not infer age or occasion without evidence.

## Product Principles
The camera is the hook; the portfolio is the proof. Show work before services. Keep the route to Facebook clear. Preserve original assets. Design a distinct touch experience.
